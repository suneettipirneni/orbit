...
- Name: anki-browser-bulk-workflows.spec.ts >> ANKI-BROWSER-012: Clear Unused Tags removes tags not assigned to notes
- Location: e2e/anki-browser-bulk-workflows.spec.ts:4:1
...
Locator: getByRole('dialog', { name: 'Clear Unused Tags' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Clear Unused Tags' })
    - waiting for" http://127.0.0.1:5173/decks/deck-1" navigation to finish...
    - navigated to "http://127.0.0.1:5173/decks/deck-1"
